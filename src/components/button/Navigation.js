  ...
  return (
    <div className="bottom-nav">
      ...
      <motion.div
        ...
        transition={{ duration: 0.5 }}
      >
        <FontAwesomeIcon icon={faHeart} className="me-2" style={{ color: 'white' }} />
      </motion.div>
      <motion.div
        className="nav-item"
        ...
        transition={{ duration: 0.5 }}
      >
        <FontAwesomeIcon icon={faMapMarkerAlt} className="me-2" style={{ color: 'white' }} />
      </motion.div>
      <motion.div
        className="nav-item"
        ...
        transition={{ duration: 0.5 }}
      >
        <FontAwesomeIcon icon={faGifts} className="me-2" style={{ color: 'white' }} />
      </motion.div>
      <motion.div
        className="nav-item"
        ...
        transition={{ duration: 0.5 }}
      >
        <FontAwesomeIcon icon={faCommentAlt} className="me-2" style={{ color: 'white' }} />
      </motion.div>
    </div>
  );
};
