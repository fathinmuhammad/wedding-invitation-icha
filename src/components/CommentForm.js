...
const CommentForm = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ fontSize: "1.8rem", color: "#800020", marginBottom: "1rem" }}>
          Ucapan &amp; Doa
        </h2>

        <p style={{ fontSize: "0.7rem", color: "#800020", marginBottom: "0rem" }}>
          Berikan ucapan terbaik untuk kedua mempelai <br />
        </p>
        ...
        <motion.div
          ...
          <div style={{ marginTop: "1rem", marginBottom: "1rem" }}>
            <h3 style={{ fontSize: "1.2rem", color: "#E7D5C5" }}>
