...
const InvitationEnd = () => {
  return (
    <div className="invitation-bridge" style={{
        minHeight: '100vh',
        background: '#7B1E34', // Soft red gradient
            ...
            ></motion.div>
              ...
              <motion.div
                 ...
                 <motion.p
                    ...
                    transition={{ duration: 1 }}
                  >
                    Merupakan suatu kehormatan dan kebahagiaan bagi kami sekeluarga, apabila Bapak/Ibu/Saudara/i <br />
                ...
                style={{ fontSize: "1.35rem", color: '#800020', fontFamily: "'Cairo', sans-serif", }}
                initial={{ x: "-100vw" }}
                animate={{ x: 0 }}
                transition={{ duration: 0.7 }}
                >
